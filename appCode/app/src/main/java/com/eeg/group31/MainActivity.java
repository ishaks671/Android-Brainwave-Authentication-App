            ...
            public void onClick(View v) {
                ...
                if(serverType.getSelectedItemPosition() == 0)
                    ...
                    if(algo == 0){
                        ...
                        //nbi = new NaiveBayesIntegration(mainActivity);
                        //nbi.runNB(trainDataFile, testDataFolder + name + ".txt", authResult, t1);
                    }else if(algo == 1){
                        svmI = new SVMIntegration(mainActivity, trainDataFile, outputModelPath, testDataFolder + name + ".txt", predictedFile);
